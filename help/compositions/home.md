...
![Um exemplo de fluxo de trabalho de composição é exibido na composição de público-alvo federado.](assets/compositions/composition-example.png){zoomable="yes"}{width="70%"}

## Componentes de composição {#components}

Uma composição na Composição do Federated Audience é composta pelas seguintes partes:
...
Você pode aprender a iniciar ou parar uma composição no [criar guia de composição](./create-composition.md#monitor-logs).

![Uma lista de composições disponíveis é exibida.](assets/compositions/compositions-list.png){zoomable="yes"}{width="70%"}
...
![É exibida uma lista das colunas disponíveis para adicionar à página de navegação das composições.](assets/compositions/compositions-columns.png){zoomable="yes"}{width="70%"}
...
![O botão &quot;Gerenciar acesso&quot; está realçado na tela de composição.](assets/compositions/select-manage-access.png){zoomable="yes"}{width="70%"}
...
![O popover Gerenciar acesso é exibido. Isso mostra uma lista de todos os rótulos disponíveis aplicáveis à composição.](assets/compositions/manage-access.png){zoomable="yes"}{width="70%"}
...
Você pode criar uma composição para o Adobe Experience Platform usando a Composição de público-alvo. Para obter mais informações, leia o [criar um guia de composição](./create-composition.md).
