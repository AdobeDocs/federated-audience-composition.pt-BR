...
* **Visualização da tela do modelo de dados**
  ...
  A visualização de tela da seção Modelos de dados melhora a experiência por permitir a visualização de modelos de dados e seus links em um layout de tela, juntamente com a exibição em tabelas existente. [Saiba mais](../data-modelling/models.md)
