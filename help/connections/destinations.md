...
1. Selecione o **[!UICONTROL Banco de dados federado]** ao qual você deseja se conectar, seguido de **[!UICONTROL Próximo]**.
...
1. A nova conexão com o destino é criada. Agora você pode ativar os públicos-alvo para enviá-los ao destino. Para fazer isso, selecione-o na lista, seguido por **[!UICONTROL Próximo]**
