...
Antes de definir a configuração da Google Cloud Platform, são necessários os seguintes valores:
...
| Provedor habilitado | Um booleano que determina se o provedor está ativado ou desativado. |
