...
## Quais permissões são necessárias para acessar o Federated Audience Composition?
...
Para usar a Composição de público-alvo federado, cada usuário deve ser adicionado a um perfil específico criado para cada sandbox. Para obter mais informações, acesse a página [Acessar Composição de público-alvo federado](./start/access-prerequisites.md).
...
Atualmente, os seguintes depósitos na nuvem são suportados:
...
Para obter mais informações sobre como se conectar a um data warehouse, leia a [visão geral de conexões](./connections/home.md).
...
## Como posso criar e gerenciar solicitações de privacidade com o Federated Audience Composition?
