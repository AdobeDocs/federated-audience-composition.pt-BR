...
Ela também permite conexões seguras com bancos de dados do Databricks hospedados no Amazon Web Services (AWS). [Saiba mais](../connections/federated-db.md#databricks)
