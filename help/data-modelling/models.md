...
Um modelo de dados é um conjunto de esquemas, públicos-alvo e links entre eles. Você pode usar modelos para combinar os dados do banco de dados nos públicos-alvo.
...
2. Preencha o formulário fornecido para definir o link.
   ...
   * **1-1**: uma ocorrência da tabela de origem pode ter, no máximo, uma ocorrência correspondente da tabela de público-alvo.
   ...
   ![O botão de adição está realçado, o que permite criar um link de junção múltipla para o modelo.](assets/models/multi-join.png){zoomable="yes"}
...
2. Selecione o botão ![](assets/models/do-not-localize/Smock_AddCircle_18_N.svg) ao lado do Join do Source e arraste e guie a seta em direção ao Join do Target para estabelecer a conexão.
